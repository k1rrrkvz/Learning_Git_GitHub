...
## Отчёт
*Сформировать Word-файл с проделанной работой. Для каждой команды, которая вам не полностью понятна:*

- Задайте вопрос в DeepSeek
- Изучите ответ
- Под скриншотом выполнения команды вставьте ваше собственное пояснение на основе ответа DeepSeek
